...
__copyright__ = "Copyright 2015, Data Weekends"
__license__ = "MIT"
__email__ = "info@dataweekends.com"

"""
Separating Flowers
This script explores a classic Machine Learning Dataset: the Iris dataset
- train_test_split
...
#
# - try separating 3 classes of flowers using the ```iris.csv``` file
